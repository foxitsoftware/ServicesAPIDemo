...
class Compress:
    def __init__(self):
        ...
        self.input_file_path = '../input_files/original1.pdf'
        self.output_file_path = '../output_files/compression/CompressionResultFile.pdf'
    ...
    def compress_task(self, input_file):
        compressionLevelString = 'high'

        queryParams = {
            'clientId': self.client_id,
            'compressionLevel': compressionLevelString
        }
        ...
        payload = {'compressionLevel':compressionLevelString}
        ...
        response = requests.request("POST", self.build_uri('document/compress'), 
