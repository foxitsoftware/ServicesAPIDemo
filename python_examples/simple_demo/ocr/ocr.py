...
class OCR:
    def __init__(self):
        ...
        self.output_file_path = '../output_files/ocr/AboutFoxit_ocr.txt'
    ...
    def ocr_task(self, input_file):
        ...
        response = requests.request("POST", self.build_uri('document/ocr'), 
