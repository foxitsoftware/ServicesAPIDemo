...
class Removepassword:
    def __init__(self):
        ...
        self.input_file_path = '../input_files/AboutFoxit_123.pdf'
        self.output_file_path = '../output_files/removePassword/AboutFoxit_RemovePassword.pdf'
    ...
    def removepassword_task(self, input_file, password):
        ...
        response = requests.request("POST", self.build_uri('document/removePassword'), 
    ...
    def start(self):
        try:
            ...
            task_id = self.removepassword_task(self.input_file_path, "123")
            doc_id = self.poll_for_docid(task_id)
            self.down_load_file_by_docid(doc_id, self.output_file_path)
            print('Remove password successfully!')
