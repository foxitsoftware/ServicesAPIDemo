...
class Split:
    def __init__(self):
        ...
        self.output_file_path = '../output_files/split/Split.zip'
    ...
    def split_task(self, input_file):
        ...
        response = requests.request("POST", self.build_uri('document/split'), 
    ...
    def start(self):
        try:
            ...
            task_id = self.split_task(self.input_file_path)
