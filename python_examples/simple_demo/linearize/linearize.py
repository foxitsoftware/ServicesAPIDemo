...
class Linearize:
    def __init__(self):
        ...
        self.output_file_path = '../output_files/linearize/Linearize.pdf'
    ...
    def linearize_task(self, input_file):
        ...
        response = requests.request("POST", self.build_uri('document/linearize'), 
                    params=params, files=files, timeout=60*1000)
