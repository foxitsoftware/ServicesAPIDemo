...
class CreatePDFFromOthers:
    def __init__(self):
        ...
        self.input_file_path = '../input_files/AboutFoxit.doc'
        self.output_file_path = '../output_files/create_pdf_from_others/AboutFoxit.pdf'
    ...
    def create_pdf_task(self, input_file_path, format='word'):
        params = {'sn':self.sn, 'clientId':self.client_id}
        payload = {'format': format}
        filename = os.path.basename(input_file_path)
        files = {
            ('inputDocument', (filename, open(input_file_path,'rb'), 'application/msword'))
            }
        ...
        response = requests.request("POST", self.build_uri('document/create'), 
...
if __name__ == '__main__':
    create_pdf_from_others = CreatePDFFromOthers()
