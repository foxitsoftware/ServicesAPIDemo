...
class Flatten:
    def __init__(self):
        ...
        self.input_file_path = '../input_files/Annot_all.pdf'
        self.output_file_path = '../output_files/flatten/flatten.pdf'
    ...
    def compress_task(self, input_file):
        ...
        response = requests.request("POST", self.build_uri('document/flatten'), 
    ...
    def start(self):
        try:
            ...
            print('Flatten PDF successfully!')
