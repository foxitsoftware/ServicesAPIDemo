...
class Manipulation:
    def __init__(self):
        ...
        self.output_file_path = '../output_files/manipulation/Manipulation.pdf'
    ...
    def manipulation_task(self, input_file):
        configString = '[{\r\n  \"pageAction\": \"move\",\r\n  \"pages\": [0],\r\n  \"angle\": 0,\r\n  \"destination\": 1\r\n}]'
        queryParams = {
        ...
        response = requests.request("POST", self.build_uri('document/manipulation'), 
