...
class Watermark:
    def __init__(self):
        ...
        self.output_file_path = '../output_files/watermark/Watermark.pdf'
    ...
    def watermark_task(self, input_file):
        ...
        payload = {"font": fontString,             'pageRange' : 'all',
            'type' : 'textObject',
            'scaleX' : 1,
            'scaleY' : 1,  
            'offsetX' : 20, 
        ...
        response = requests.request("POST", self.build_uri('document/watermark'), 
