...
class Compress {
    ...
    private $secretId = '';
    private $sn = 'testsn';
    private $inputFilePath = '../input_files/original1.pdf';
    private $outputFilePath = '../output_files/compression/CompressionResultFile.pdf';
    ...
    private function compressTask($inputFile) {
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $this->buildUri('document/compress') . '?' . http_build_query($params));
