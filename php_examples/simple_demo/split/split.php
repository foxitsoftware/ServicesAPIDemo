...
//
// This file contains an example to demonstrate how to use Foxit Cloud API to split pdf files.
...
class Split
{
    ...
    private $outputFilePath = '../output_files/split/Split.zip';
    ...
    public function splitTask($inputFilePath, $password)
    {
		$configString = "{\r\n  \"pageCount\": 1\r\n}";
        $queryParams = [
