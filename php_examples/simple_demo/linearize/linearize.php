...
class Linearize {
    ...
    private $outputFilePath = '../output_files/linearize/Linearize.pdf';
    ...
    // Linearize the PDF document
    private function linearizeTask($inputFile) {
        $queryParams = [
        ...
        $files = ['inputDocument' => $file];

        // Upload file and create a new workflow task
        $ch = curl_init($this->buildUri('document/linearize') . '?' . http_build_query($params));
