...
class Manipulation
{
    ...
    private $outputFilePath = '../output_files/manipulation/Manipulation.pdf';
    ...
    public function manipulationTask($inputFilePath)
    {
        $configString = "[{\r\n  \"pageAction\": \"move\",\r\n  \"pages\": [0],\r\n  \"angle\": 0,\r\n  \"destination\": 1\r\n}]";
        $queryParams = [
        ...
        $ch = curl_init($this->buildUri('document/manipulation') . '?' . http_build_query($params));
