...
namespace Sign
{
    ...
    class Sign
    {
        ...
        private string SignTask(string input_file, string input_image_file)
        {
            ...
            var request = new RestRequest("document/sign", Method.Post);
            request
              .AddHeader("Accept", "application/json")
              .AddQueryParameter("sn", sn)
              .AddQueryParameter("clientId", client_id)
              .AddFile("inputDocument", input_file, "multipart/form-data")
              .AddFile("stampImage", input_image_file_path, "multipart/form-data")
              .AddParameter("certId", cert_id)
              .AddParameter("pageIndex", page_index)
              .AddParameter("signatureRect", rect)
              .AddParameter("appearanceFlag", appearance_flag)
              .AddParameter("signer", signer)
              .AddParameter("text", text)
              .AddParameter("location", location)
              .AddParameter("reason", reason)
              .AddParameter("contactInfo", contact_info);
