...
namespace Sign
{
    ...
    class Sign
    {
        ...
        private const string input_image_file_path = "../input_files/Image.jpg";

        private const string output_file_path = "../output_files/sign/AboutFoxitSign.pdf";
        ...
        private string SignTask(string input_file, string input_image_file)
        {
            int page_index = 1;
            String rect = "[0, 0, 200, 200]";
            String appearance_flag = "[\"APFlagReason\", \"APFlagSigningTime\", \"APFlagLocation\", \"APFlagSigner\", \"APFlagImage\", \"APFlagText\"]";
            String signer = "Foxit Software Inc.";
            String text = "Foxit Software Inc.";
            String location = "Beijing, China";
            String reason = "Foxit Cloud API Demo";
            String contact_info = "https://developers.foxitsoftware.cn/";
            ...
            var query_params = new Dictionary<string, string>
            {
                ...
                { "signatureRect", rect },
                { "appearanceFlag", appearance_flag },
                { "signer", signer },
                { "text", text },
                { "location", location },
                { "reason", reason },
            ...
            string url = $"https://servicesapi.foxitsoftware.cn/api/document/sign?sn={sn}&clientId={client_id}";
            ...
            formData.Add(CreateEncodedFileContent(input_image_file_path, "stampImage"));
            formData.Add(new StringContent(cert_id), "certId");
            formData.Add(new StringContent(page_index.ToString()), "pageIndex");
            formData.Add(new StringContent(rect), "signatureRect");
            formData.Add(new StringContent(appearance_flag), "appearanceFlag");
            formData.Add(new StringContent(signer), "signer");
            ...
            formData.Add(new StringContent(contact_info), "contactInfo");
        ...
        public static void Start()
        {
            ...
            {
                Sign sign = new Sign();
                sign.GetCredentialsParams(Directory.GetCurrentDirectory() + "/foxit_cloud_api_credentials.json");
                string task_id = sign.SignTask(input_file_path, input_image_file_path);
                string doc_id = sign.PollForDocId(task_id);
                sign.DownLoadFileByDocId(doc_id, output_file_path);
                Console.WriteLine("Sign PDF successfully!");
            }
            catch (RestException e)
            {
