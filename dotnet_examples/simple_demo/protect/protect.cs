...
namespace ProtectCS
{
    ...
    class Protect
    {
        ...
        private string ProtectPDFTask(string input_file_path)
        {
            ...
            var request = new RestRequest("document/protect", Method.Post);
            request
              ...
              .AddParameter("passwordProtection", passwordProtection)
              .AddParameter("permission", permission)
              .AddParameter("encryptionAlgorithm", encryptionAlgorithm);
