...
namespace ProtectCS
{
    ...
    class Protect
    {
        ...
        private const string output_file_path = "../output_files/protect/AboutFoxitPassword123.pdf";
        ...
        private string ProtectPDFTask(string input_file_path)
        {
            string passwordProtection = "{\r\n  \"userPassword\": \"123\",\r\n  \"ownerPassword\": \"456\" \r\n}";
            string permission = "[\"EDIT_ANNOTATION\", \"EDIT_CONTENT\"]";
            string encryptionAlgorithm = "AES_128";
            ...
            string url = $"https://servicesapi.foxitsoftware.cn/api/document/protect?sn={sn}&clientId={client_id}";
            ...
            formData.Add(new StringContent(passwordProtection), "passwordProtection");
            formData.Add(new StringContent(permission), "permission");
            formData.Add(new StringContent(encryptionAlgorithm), "encryptionAlgorithm");
        ...
        public static void Start()
        {
            ...
            try
            {
                ...
                protect.GetCredentialsParams(Directory.GetCurrentDirectory() + "/foxit_cloud_api_credentials.json");
                string task_id = protect.ProtectPDFTask(input_file_path);
                string doc_id = protect.PollForDocId(task_id);
                protect.DownLoadFileByDocId(doc_id, output_file_path);
                Console.WriteLine("Protect PDF successfully!");
            }
            catch (RestException e)
            {
