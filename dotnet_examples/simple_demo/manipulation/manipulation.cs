...
//
// This file contains an example to demonstrate how to use Foxit Cloud API to manipulate pdf pages.
...
namespace ManipulationCS
{
    ...
    class Manipulation
    {
        ...
        private const string output_file_path = "../output_files/manipulation/Manipulation.pdf";
        ...
        //pageAction can be delete, move, rotate.
        private string ManipulationPDFTask(string input_file_path)
        {
            string config = "[{\r\n  \"pageAction\": \"move\",\r\n  \"pages\": [0],\r\n  \"angle\": 0,\r\n  \"destination\": 1\r\n}]";
            ...
            string url = $"https://servicesapi.foxitsoftware.cn/api/document/manipulation?sn={sn}&clientId={client_id}";
        ...
        public static void Start()
        {
            ...
            try
            {
                ...
                manipulation.GetCredentialsParams(Directory.GetCurrentDirectory() + "/foxit_cloud_api_credentials.json");
                string task_id = manipulation.ManipulationPDFTask(input_file_path);
                string doc_id = manipulation.PollForDocId(task_id);
                manipulation.DownLoadFileByDocId(doc_id, output_file_path);
                Console.WriteLine("Manipulate PDF successfully!");
            }
            catch (RestException e)
            {
