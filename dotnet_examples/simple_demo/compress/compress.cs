...
namespace CompressCS
{
    ...
    class Compress
    {
        ...
        private const string input_file_path = "../input_files/original1.pdf";
        private const string output_file_path = "../output_files/compression/CompressionResultFile.pdf";
        ...
        private string CompressPDFTask(string input_file_path)
        {
            ...
            string url = $"https://servicesapi.foxitsoftware.cn/api/document/compress?sn={sn}&clientId={client_id}";
            ...
            formData.Add(new StringContent(compression_level), "compressionLevel");
        ...
        public static void Start()
        {
            ...
            try
            {
                ...
                compress.GetCredentialsParams(Directory.GetCurrentDirectory() + "/foxit_cloud_api_credentials.json");
                string task_id = compress.CompressPDFTask(input_file_path);
                string doc_id = compress.PollForDocId(task_id);
                compress.DownLoadFileByDocId(doc_id, output_file_path);
                Console.WriteLine("Compress PDF file successfully!");
            }
            catch (RestException e)
            {
