...
namespace FlattenCS
{
    ...
    class Flatten
    {
        ...
        private const string input_file_path = "../input_files/Annot_all.pdf";
        private const string output_file_path = "../output_files/flatten/flatten.pdf";
        ...
        private string FlattenPDFTask(string input_file_path)
        {
            ...
            string url = $"https://servicesapi.foxitsoftware.cn/api/document/flatten?sn={sn}&clientId={client_id}";
        ...
        public static void Start()
        {
            ...
            try
            {
                ...
                flatten.GetCredentialsParams(Directory.GetCurrentDirectory() + "/foxit_cloud_api_credentials.json");
                string task_id = flatten.FlattenPDFTask(input_file_path);
                string doc_id = flatten.PollForDocId(task_id);
                flatten.DownLoadFileByDocId(doc_id, output_file_path);
                Console.WriteLine("Flatten PDF successfully!");
            }
            catch (RestException e)
            {
