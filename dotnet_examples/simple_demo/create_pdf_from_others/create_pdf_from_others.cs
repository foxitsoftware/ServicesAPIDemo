...
namespace CreatePDFFromOthersCS
{
    ...
    class CreatePDFFromOthers
    {
        ...
        private const string input_file_path = "../input_files/AboutFoxit.doc";
        private const string output_file_path = "../output_files/create_pdf_from_others/AboutFoxit.pdf";
        ...
        private string CreatePDFTask(string input_file_path, string format = "word")
        {
            ...
            string url = $"https://servicesapi.foxitsoftware.cn/api/document/create?sn={sn}&clientId={client_id}";
            ...
            formData.Add(CreateEncodedFileContent(input_file_path, "inputDocument"));
        ...
        public static void Start()
        {
            ...
            try
            {
                CreatePDFFromOthers create_pdf_from_others = new CreatePDFFromOthers();
                create_pdf_from_others.GetCredentialsParams(Directory.GetCurrentDirectory() + "/foxit_cloud_api_credentials.json");
                string task_id = create_pdf_from_others.CreatePDFTask(input_file_path);
                string doc_id = create_pdf_from_others.PollForDocId(task_id);
                create_pdf_from_others.DownLoadFileByDocId(doc_id, output_file_path);
                Console.WriteLine("Create PDF successfully!");
            }
            catch (RestException e)
            {
