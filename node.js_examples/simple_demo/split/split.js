...
const outputFilePath = '../output_files/split/Split.zip'
...
function splitPDFTask(inputFilePath){
  let config = {
    pageCount : 1
  }
...
start().then(function(){
  console.log("Split PDF file successfully!");
  process.exit(0)
}).catch(function(err){
  console.log("Split PDF file failed: " + err);
  process.exit(1)
})