...
const outputFilePath = '../output_files/watermark/Watermark.pdf'
...
function watermarkTask(inputFilePath){
  let font = {
...
start().then(function(){
  ...
  console.log("Add watermark failed: " + err);
  process.exit(1)
})