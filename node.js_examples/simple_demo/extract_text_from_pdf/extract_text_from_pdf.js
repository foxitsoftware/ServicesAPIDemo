...
const outputFilePath = '../output_files/extract_text_from_pdf/AboutFoxit.txt'
...
start().then(function(){
  console.log("Extract text from PDF successfully!");
  process.exit(0)
}).catch(function(err){
  console.log("Extract text from PDF failed: " + err);
  process.exit(1)
})