...
package com.foxit.simple_demo.sign;
...
public class Sign {
	...
	private static final String input_image_file_path = "./input_files/Image.jpg";
    ...
    private String signTask(String input_file_path, String input_image_file) throws Exception {
        int page_index = 1;
		...
		query_params.put("certId", cert_id);
        query_params.put("pageIndex", Integer.toString(page_index));
        query_params.put("signatureRect", rect);
        query_params.put("appearanceFlag", appearance_flag);
        query_params.put("signer", signer);
        ...
        RequestBody body = new MultipartBody.Builder()
            ...
            .addFormDataPart("stampImage", image_file_name, RequestBody
            .create(new File(input_image_file), MediaType.parse("text/plain")))
            .addFormDataPart("certId", cert_id)
            .addFormDataPart("pageIndex", Integer.toString(page_index))
            .addFormDataPart("signatureRect", rect)
            .addFormDataPart("appearanceFlag", appearance_flag)
            .addFormDataPart("signer", signer)
    ...
    public static void start() throws Exception {
        ...
        Sign sign = new Sign();
        sign.getCredentialsParams("foxit_cloud_api_credentials.json");
        String task_id = sign.signTask(input_file_path , input_image_file_path);
        String doc_id = sign.pollForDocId(task_id, 2000);
        sign.downLoadFileByDocId(doc_id, output_file_path);
        System.out.println("Sign PDF successfully!");
    }
