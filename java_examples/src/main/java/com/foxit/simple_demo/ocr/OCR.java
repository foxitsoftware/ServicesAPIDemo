...
package com.foxit.simple_demo.ocr;
...
public class OCR {
    ...
    private String ocrTask(String input_file) throws Exception {
        ...
        query_params.put("lang", lang);
        query_params.put("outputFormat", outputFormat);
        ...
        HttpUrl url = buildURI("document/ocr")
    ...
    public static void start() throws Exception {
        ...
        OCR ocr = new OCR();
        ocr.getCredentialsParams("foxit_cloud_api_credentials.json");
        String task_id = ocr.ocrTask(input_file_path);
        String doc_id = ocr.pollForDocId(task_id, 2000);
        ocr.downLoadFileByDocId(doc_id, output_file_path);
        System.out.println("OCR PDF file successfully!");
    }
